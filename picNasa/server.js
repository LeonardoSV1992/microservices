...
const tracer = initTracer("PICOFDAY TRACK");
app.get('/', (req, res) =>{res.send("Running Nasa Picture");})

app.get('/getpic', (req, res)=>{
  const span = tracer.startSpan("GET PICTURE OF THE DAY");
    axios({
        "method":"POST",
        ...
        .then((response)=>{
          console.log(response.data.contextWrites)
